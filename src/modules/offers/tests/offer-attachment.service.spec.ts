...
describe('OfferAttachmentService', () => {
  ...
  describe('uploadAttachment', () => {
    ...
    it('should upload attachment successfully', async () => {
      ...
      const result = await service.uploadAttachment('offer-1', mockFile, 1);
    ...
    it('should throw NotFoundException when offer does not exist', async () => {
      ...
      await expect(service.uploadAttachment('non-existent', mockFile, 1)).rejects.toThrow(
        NotFoundException
      );
    });
    ...
    it('should throw ForbiddenException when user is not the offer owner', async () => {
      ...
      await expect(service.uploadAttachment('offer-1', mockFile, 1)).rejects.toThrow(
        ForbiddenException
      );
    });
    ...
    it('should throw BadRequestException for invalid file type', async () => {
      ...
      await expect(service.uploadAttachment('offer-1', invalidFile, 1)).rejects.toThrow(
        BadRequestException
      );
    });
    ...
    it('should throw BadRequestException for file too large', async () => {
      ...
      await expect(service.uploadAttachment('offer-1', largeFile, 1)).rejects.toThrow(
        BadRequestException
      );
    });
  ...
  describe('deleteAttachment', () => {
    ...
    it('should delete attachment successfully', async () => {
      ...
      await service.deleteAttachment('attachment-1', 1);
    ...
    it('should throw NotFoundException for non-existent attachment', async () => {
      ...
      await expect(service.deleteAttachment('non-existent', 1)).rejects.toThrow(NotFoundException);
    });
    ...
    it('should throw ForbiddenException when user is not the owner', async () => {
      ...
      await expect(service.deleteAttachment('attachment-1', 1)).rejects.toThrow(ForbiddenException);
    });
  });
});
