...
export class SellerController {
  ...
  async buildRegister(
    ...
    const result = await this.sellerService.buildRegister(req.user.id, buildRegisterDto);
  ...
  async submitRegister(
    ...
    const result = await this.sellerService.submitRegister(req.user.id, submitRegisterDto);
  ...
  async getRegistrationStatus(@Request() req: AuthenticatedRequest) {
    const result = await this.sellerService.getRegistrationStatus(req.user.id);
